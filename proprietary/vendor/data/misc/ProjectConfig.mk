...
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6_mipi_raw_sub gc2375hmipi_raw s5k4h7yx_mipi_raw
...
CUSTOM_HAL_SUB_IMGSENSOR = s5k3l6_mipi_raw_sub
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6_mipi_raw_sub gc2375hmipi_raw s5k4h7yx_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3l6_mipi_raw_sub
...
CUSTOM_MODEM = 6310A_R3.MP.V66_P3_v007
...
TRUSTKERNEL_TEE_VER_PATCH = file_36m
...
FISE_PRODUCT_MANUFACTURER=GIONEE
FISE_CUSTOM_DEFINE_CLIENTID=android-jaina
FISE_BETTERLIFE_SEPOLICY_TEE=yes
FISE_PROJECT_DEFINE_BY_NAME = M6310_PRJ_IMGSENSOR_MIPI_CTRL FISE_CAM_LDO_MULTIPLE_VOLTAGE M6310_HM_IMGSENSOR_OTP M6310_HM_NTC_CUSTOMIZE FISE_CHARGER_PLUGIN_WITCH_VIBRATOR M6310_HM_FRONT_CAMERA_AUTO_LCM_FLASHLIGHT
FISE_AUDIO_DEFINE_BY_NAME = FISE_PHONE_MIC_MODE_ACC FISE_HEADSET_MIC_MODE_ACC 
PROJECT_FISE_APP_USE=MT6763_6310_PD6501
BUILD_GMS=yes
GMS_NORMAL_SUPPORT=yes
GMS_CALENDAR_SUPPORT=yes
FISE_CHROME_OVERRIDES_BROWSER=yes
GMS_GOOGLE_CONTANTS_SUPPORT=no
GMS_CALCULATOR_SUPPORT=yes
GMS_FILEGO_SUPPORT=no
GMS_DESKCLOCK_SUPPORT=no
FISE_GMAIL_OVERRIDES_EMAIL=yes
GMS_MESSAGES_SUPPORT=yes
GMS_LATINIMEGOOGLE_SUPPORT=yes
FISE_PRODUCT_MODEL=GIONEE F10 Plus
FISE_PRODUCT_BRAND=GIONEE
FISE_PRODUCT_BOARD=F10_Plus
FISE_PRODUCT_NAME=F10_Plus
FISE_PRODUCT_DEVICE=F10_Plus
FISE_BUILD_PRODUCT=F10_Plus
REDSTONE_FOTA_SUPPORT=no
REDSTONE_FOTA_APK_ICON=no
REDSTONE_FOTA_APK_KEY=none
REDSTONE_FOTA_APK_CHANNELID=none
FISE_REMOVE_LIVE_WALLPAPER = yes
TRUSTKERNEL_TEE_PLATFORM_APP_SUPPORT=yes
TRUSTKERNEL_TEE_SUPPORT=yes
FISE_NO_DATAPROTECTION=yes
FISE_BUILD_NUMBER=1574680250
FSSZ_FISE_BUILD_NUMBER=1574680250

#add by zougui,for app append special camera resolutions
FISE_ADD_SPECIAL_SIZE=yes
M6310_S5K3L6_MAIN_ADD_SPECIAL_SIZE=yes
M6310_S5K3L6_SUB_ADD_SPECIAL_SIZE=yes


#add by zougui ,for awinic algorithm
AWINIC_EFFECT_SUPPORT=yes
AWINIC_SKT_ALGORITHM_SUPPORT=yes
TARGET_360_PROJECT:=FISE_GIONEE_PD6501G_OE

#add by jerry.xie for BST bokeh
BST_BOKEH_SUPPORT = yes
BST_BOKEH_SUPPORT_13M=yes
#-- end
FISE_GMS_NO_PLUS=yes

### --- Auto gen, not modify! ---###

FS_NOT_GMS_CERTIFIED_DEMO_VERSION=no

MTK_BUILD_VERNO = alps-mp-p0.mp7-V2.35_P8

MTK_WEEK_NO = W19.45

FS_BUILD_SW_VERSION=GIONEE_F10_Plus_V07_20191206_userdebug

FS_SW_FIXED_VERSION=GIONEE_F10_Plus_V07_userdebug
